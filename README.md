...
> Advanced OCR with table detection and document layout analysis
...
```bash
git clone https://github.com/jaychampaneri14/advanced-ocr-system.git
...
Main libraries: Computer Vision, Python, Ocr
